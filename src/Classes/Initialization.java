...
public class Initialization {
    public static ObservableList<Class> classList(String path) throws Exception {
    ...
    public static ObservableList<Lecturer> lecturerList (String path) throws Exception {
    ...
    public static ObservableList<Staff> staffList (String path) throws Exception {
